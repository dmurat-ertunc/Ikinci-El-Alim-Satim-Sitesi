        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UrunCesiti = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KategorilerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    KategorilerId1 = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IlanAd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Aciklama = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Yil = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Fiyat = table.Column<int>(type: "int", nullable: false),
                    IlanSehir = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    IlanIlce = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    FotoUrl4 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FotoUrl5 = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
